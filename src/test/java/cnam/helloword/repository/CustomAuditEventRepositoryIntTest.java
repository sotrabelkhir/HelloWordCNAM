package cnam.helloword.repository;

import cnam.helloword.HelloWordCnamApp;
import cnam.helloword.config.Constants;
import cnam.helloword.config.audit.AuditEventConverter;
import cnam.helloword.domain.PersistentAuditEvent;
...
import static cnam.helloword.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
